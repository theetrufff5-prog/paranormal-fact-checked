(() => {
  const records = [
    { title: "Goatman's Bridge", location: "Denton County, Texas", tags: "old alton bridge goatman oscar washburn denton ghost adventures route 666", summary: "Historic bridge facts separated from an unsupported origin story and paranormal claims.", url: "goatmans-bridge.html" },
    ...
    { title: "The Bermuda Triangle", location: "Western North Atlantic", tags: "bermuda triangle flight 19 uss cyclops marine sulphur queen ship aircraft disappearances atlantis aliens compass television", summary: "Documented losses separated from exaggerated stories and unsupported paranormal explanations.", url: "bermuda-triangle.html" },
